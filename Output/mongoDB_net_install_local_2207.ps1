...
"@
    ...
    -ArgumentList "$mongoConnectionString --file `"$mongoScriptPath`"" `
    -Wait -PassThru `
    -RedirectStandardOutput C:\data\mongosh_output.log `
    -RedirectStandardError C:\data\mongosh_error.log `
    -WindowStyle Hidden `
...
$InsatalltionFile = "All_Installation" 
