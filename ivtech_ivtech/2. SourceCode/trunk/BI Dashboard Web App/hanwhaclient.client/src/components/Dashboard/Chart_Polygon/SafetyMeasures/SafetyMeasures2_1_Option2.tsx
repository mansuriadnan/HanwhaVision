...
const SafetyMeasures2_1_Option2: React.FC<ISafetyMeasuresDataProps> = ({
  ...
  const categories: { key: SMKey; label: string; color: string }[] = [
    { key: "withMask", label: "With Mask", color: "#68BBFF" },
    { key: "withoutMask", label: "Without Mask", color: "#FFF952" },
  ...
  useEffect(() => {
    ...
    const margin = { top: 30, right: 30, bottom: 145, left: 30 };
    ...
    MultiLinechartGroup.append("g")
      ...
      .style("font-size", "10px");
  }, [customizedWidth, customizedHeight, finalData]);
