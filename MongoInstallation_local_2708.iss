...
Filename: "schtasks.exe"; Parameters: "/Create /TN ""MyService"" /TR ""powershell.exe -ExecutionPolicy Bypass -WindowStyle Hidden -File '{app}\testrunningapp.ps1'"" /SC ONSTART /RU SYSTEM /RL HIGHEST /F"; Flags: runhidden waituntilterminated



[UninstallRun]
Filename: "schtasks.exe"; Parameters: "/Delete /TN ""MyService"" /F"; Flags: runhidden
...
begin
  ...
  begin
    if not (IISSetupCheckBox.Checked Or InstallDotNetSDKCheckBox.Checked  or NetHostingCheckBox.Checked or MongoDBCheckBox.Checked or 
