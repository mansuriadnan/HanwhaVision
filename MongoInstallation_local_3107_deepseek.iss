...
[Icons]
Name: "{userdesktop}\Vision Insight"; Filename: "http://localhost:8080"; IconFilename: "{app}\Group_1.ico"; Check: ShouldCreateShortcut
...
begin
  ...
  CreateShortcutCheckBox.Top := ScaleY(160);
...
begin
  ...
  ShortcutPath := DesktopPath + '\Vision Insight Test.lnk';
  
  // Create batch file to launch localhost
  BatchFile := ExpandConstant('{app}\launch.bat');
  BatchContent := '@echo off' + #13#10 + 'start http://localhost:8080';
