...
[Setup]
AppName=MongoDB .NET Installation Tool 3007
AppVersion=1.0
DefaultDirName={autopf}\MongoDB .NET Installer
DefaultGroupName=MongoDB .NET Installer 3007
OutputDir=Output
OutputBaseFilename=MongoDB_NET_Installer_Local_3007
...
[Icons]
Name: "{userdesktop}\Hanwah Vision 3007"; Filename: "http://localhost:8080"; IconFilename: "{app}\Group_1.ico"; IconIndex: 0
...
begin
  PowerShellFilePath := ExpandConstant('{tmp}\mongoDB_net_install_live_2407.ps1');
...
'' + #13#10 +
  ...
  '$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path' + + #13#10
  '$InsatalltionFile = "All_Installation" ' + #13#10
  '$mongoInstallerUrl = Join-Path $scriptDir  "$InsatalltionFile\mongodb-windows-x86_64-7.0.12-signed-2908.msi"' + #13#10
  ...
  '$PhysicalPath = "' + ExpandConstant('{src}\Publish') + '"' + #13#10 +
