...
; This line is optional since we won't embed it:
 Source: "mongoDB_net_install_live_2606.ps1"; DestDir: "{tmp}"; Flags: deleteafterinstall
...
Name: "{userdesktop}\Hanwah Vision 2606"; Filename: "http://localhost:8080"; IconFilename: "{src}\Group_1.ico"; IconIndex: 0
...
begin
  ...
  BatchContent :=
    ...
    '%SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoExit -File "%~dp0mongoDB_net_install_live_2606.ps1"' + #13#10 +
    'echo.' + #13#10 +
