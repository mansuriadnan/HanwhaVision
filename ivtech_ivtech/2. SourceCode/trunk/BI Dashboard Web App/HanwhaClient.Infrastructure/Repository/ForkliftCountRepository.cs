...
namespace HanwhaClient.Infrastructure.Repository
{
    public class ForkliftCountRepository : RepositoryBase<ForkliftCount> , IForkliftCountRepository
    {
        ...
        public async Task<IEnumerable<EventQueueAnalysis>> ForkliftCountAnalysisDataAsync(string deviceId, DateTime startdate, DateTime enddate, int channel, int intervalMinute)
        {
            var pipeline = new[]
            {
