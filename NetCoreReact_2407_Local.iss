...
[Setup]
AppName=MongoDB .NET Installation Tool 2507
AppVersion=1.0
DefaultDirName={autopf}\MongoDB .NET Installer
DefaultGroupName=MongoDB .NET Installer 2507
OutputDir=Output
OutputBaseFilename=MongoDB_Installer_Local_2507
...
; This line is optional since we won't embed it:
 Source: "mongoDB_net_install_local_2507.ps1"; DestDir: "{tmp}"; Flags: deleteafterinstall
...
Name: "{userdesktop}\Hanwah Vision Local"; Filename: "http://localhost:8080"; IconFilename: "{src}\Group_1.ico"; IconIndex: 0
...
begin
  ...
  BatchContent :=
    ...
    '%SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoExit -File "%~dp0mongoDB_net_install_local_2507.ps1"' + #13#10 +
    'echo.' + #13#10 +
