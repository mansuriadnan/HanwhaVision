...
AppVersion=1.0
DefaultDirName={pf}\Mongo-Node-NetCore-React Installer
DefaultGroupName=Mongo-Node-NetCore-React Installer
...
[Icons]
Name: "{userdesktop}\NetCoreReact_2701"; Filename: "{app}\StartApp.bat"; IconFileName: "{app}\wwwroot\favicon.ico"
