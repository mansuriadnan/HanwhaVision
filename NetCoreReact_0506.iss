...
[Setup]
AppName=MongoDB .NET Installation Tool 0506
AppVersion=1.0
DefaultDirName={autopf}\MongoDB .NET Installer
DefaultGroupName=MongoDB .NET Installer 0506
OutputDir=Output
OutputBaseFilename=MongoDB_NET_Installer_0506_Morning
...
; This line is optional since we won't embed it:
 Source: "mongoDB_net_install_live_0506.ps1"; Flags: dontcopy
...
Name: "{userdesktop}\Launch My Website 0506"; Filename: "http://localhost:8080"; IconFilename: "C:\Users\adnan.mansuri\Desktop\All_Script_File\Group_1.ico"; IconIndex: 0
...
begin
  ...
  BatchContent :=
    ...
    '%SystemRoot%\SysNative\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -NoExit -File "%~dp0mongoDB_net_install_live_0506.ps1"' + #13#10 +
    'echo.' + #13#10 +
